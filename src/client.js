...
function IconFinder() {
  return <img src={FINDER_ICON_SRC} width={14} height={14} alt="" draggable={false} style={{ display: 'block', borderRadius: 3.5 }} />
}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 6px 4px 10px', borderBottom: '1px solid ' + V.line, flex: '0 0 auto' }}>
        ...
        {state.activePath
          ? <button type="button" onClick={openFolderInSystem} data-tip={openFolderTip} aria-label={openFolderTip}
            ...
            style={{ cursor: 'pointer', flex: '0 0 auto', fontSize: 12, padding: '3px 12px', borderRadius: 6, border: 'none', background: V.accent, color: '#fff', display: 'inline-flex', alignItems: 'center', gap: 5 }}>
